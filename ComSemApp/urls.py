...
urlpatterns = [
    ...
    url(r'^admin/teacher/(?P<pk>[0-9]+)/delete/$', admin_views.TeacherDisactivate.as_view(), name='admin_disactivate_teacher'),
    ...
    url(r'^admin/student/(?P<pk>[0-9]+)/delete/$', admin_views.StudentDisactivate.as_view(), name='admin_disactivate_student'),
    ...
    url(r'^admin/course/(?P<pk>[0-9]+)/delete/$', admin_views.CourseDelete.as_view(), name='admin_delete_course'),
    ...
    url(r'^admin/course_type/(?P<pk>[0-9]+)/delete/$', admin_views.CourseTypeDelete.as_view(), name='admin_delete_course_type'),
    ...
    url(r'^admin/session/(?P<pk>[0-9]+)/delete/$', admin_views.SessionDelete.as_view(), name='admin_delete_session'),
    ...
    url(r'^admin/session_type/(?P<pk>[0-9]+)/delete/$', admin_views.SessionTypeDelete.as_view(), name='admin_delete_session_type'),
