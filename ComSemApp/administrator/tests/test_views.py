...
class TestCredentials(BaseTestCase):
    ...
    teacher_list_url = reverse("administrator:teachers")
...
class TestStudentViews(AdminTestCase, BaseTestCase):
    obj = Student
    list_url = reverse("administrator:students")
    create_url = reverse("administrator:create_student")
    update_url_string = "administrator:edit_student"
    delete_url_string = "administrator:disactivate_student"
    list_prefix = "student"
...
class TestTeacherViews(AdminTestCase, BaseTestCase):
    obj = Teacher
    list_url = reverse("administrator:teachers")
    create_url = reverse("administrator:create_teacher")
    update_url_string = "administrator:edit_teacher"
    delete_url_string = "administrator:disactivate_teacher"
    list_prefix = "teacher"
...
class TestCourseViews(AdminTestCase, BaseTestCase):
    obj = Course
    list_url = reverse("administrator:courses")
    create_url = reverse("administrator:create_course")
    update_url_string = "administrator:edit_course"
    delete_url_string = "administrator:delete_course"
    list_prefix = "course"
...
class TestCourseTypeViews(AdminTestCase, BaseTestCase):
    obj = CourseType
    list_url = reverse("administrator:course_types")
    create_url = reverse("administrator:create_course_type")
    update_url_string = "administrator:edit_course_type"
    delete_url_string = "administrator:delete_course_type"
...
class TestSessionViews(AdminTestCase, BaseTestCase):
    obj = Session
    list_url = reverse("administrator:sessions")
    create_url = reverse("administrator:create_session")
    update_url_string = "administrator:edit_session"
    delete_url_string = "administrator:delete_session"
    list_prefix = "session"
...
class TestSessionTypeViews(AdminTestCase, BaseTestCase):
    obj = SessionType
    list_url = reverse("administrator:session_types")
    create_url = reverse("administrator:create_session_type")
    update_url_string = "administrator:edit_session_type"
    delete_url_string = "administrator:delete_session_type"
